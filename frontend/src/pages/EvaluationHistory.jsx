...
function AutomaticRecommendationsSummary({
  ...
  const consolidation =
    recommendationsEngine?.consolidation || [];

  const strengths =
    recommendationsEngine?.strengths || [];

  const primaryRecommendation =
    recommendationsEngine?.primaryRecommendation ||
    null;

  const hasRecommendations =
    recommendationsEngine?.hasData === true;
  ...
  const recommendationsUrl = [
    ...
    playerId
      ...
      : '',
    teamId
      ? `${playerId ? '&' : '?'}teamId=${encodeURIComponent(
          teamId
        )}`
      : '',
  ].join('');
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm leading-6 text-slate-500">
                Ainda não existem dados suficientes para gerar
  ...
  return (
    <Card className="overflow-hidden border border-cyan-100 bg-white shadow-xl shadow-slate-200/60">
      <CardContent className="p-0">
        <div className="flex flex-col gap-5 bg-gradient-to-r from-cyan-50 via-white to-violet-50 p-5 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex min-w-0 items-start gap-4">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-sm leading-6 text-slate-500">
                Consulta prioridades, competências a consolidar e
          ...
          <Button
            asChild
            className="shrink-0 rounded-full bg-cyan-600 hover:bg-cyan-700"
          >
            <Link to={recommendationsUrl}>
    ...
    >
      ...
      {!selectedPlayerId ? (
        ...
        <>
          ...
          <AutomaticRecommendationsSummary
            recommendationsEngine={
              automaticRecommendations
            }
