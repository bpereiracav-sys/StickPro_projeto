...
export function AppLayout({ children }) {
  ...
  return (
    <div className="relative min-h-screen bg-slate-50 text-slate-900">
      ...
      <main className="relative z-10 min-h-screen pb-20 pt-16 lg:ml-64 lg:pb-0 lg:pt-20">
        <div className="mx-auto w-full max-w-7xl px-3 pb-3 pt-3 sm:px-5 sm:pb-5 lg:px-8 lg:pb-6">
